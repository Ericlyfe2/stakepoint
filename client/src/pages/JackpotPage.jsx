...
.jp-hero-bg {
  ...
  background:
    ...
    radial-gradient(420px 280px at -10% 110%, rgba(255, 184, 0, .12), transparent 60%);
  pointer-events: none;
}
...
.jp-badge.jp-badge-warm { background: rgba(255, 184, 0, .14); color: var(--accent); }
.jp-hero-inner h1 {
...
.jp-leg:hover { border-color: rgba(255, 184, 0, .25); transform: translateY(-1px); }
...
.jp-leg.picked .jp-leg-num { color: var(--accent); background: rgba(255, 184, 0, .1); }
