  ...
  return (
    <main className="page-wrap" style={{ maxWidth: 960, margin: '0 auto', padding: '32px 24px 80px' }}>
      ...
      <section id="terms" style={sectionStyle}>
        ...
        <p style={pStyle}>
          By creating a BetXentra account and placing wagers you agree to the following terms.
          You must be 18 years or older and physically located in a jurisdiction where online
          sports wagering is lawful. BetXentra operates under Ghana Gaming Commission licence
        ...
        <ul style={ulStyle}>
          ...
          <li>BetXentra reserves the right to verify identity and source of funds before processing withdrawals (KYC/AML).</li>
      ...
      <section id="privacy" style={sectionStyle}>
        ...
        <p style={pStyle}>
          BetXentra collects only the information needed to operate your account: the
      ...
      <section id="responsible-gaming" style={sectionStyle}>
        ...
        <p style={pStyle}>
          Wagering should be entertainment, not income. BetXentra provides tools to keep you
          in control:
        </p>
        <ul style={ulStyle}>
      ...
      <section id="self-exclusion" style={sectionStyle}>
        ...
        <p style={pStyle}>
          ...
          communications stop, and BetXentra will refuse re-registration attempts.
        </p>
        <p style={pStyle}>
          To self-exclude, sign in and email <a href="mailto:safe@betxentra.gh" style={linkStyle}>safe@betxentra.gh</a> from
      ...
      <section id="licence" style={sectionStyle}>
        ...
        <p style={pStyle}>
          BetXentra is operated by BetXentra Gaming Limited and licensed by the Gaming Commission
