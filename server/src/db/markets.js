...
const DEFAULT_TEMPLATES = [
  ...
  { key: 'CS',     name: 'Correct Score',       sport: 'football', description: 'Predict the exact final score.', selections: [{ key: '1-0', label: '1-0', defaultOdds: 7.00 }, { key: '2-0', label: '2-0', defaultOdds: 8.00 }, { key: '2-1', label: '2-1', defaultOdds: 8.50 }, { key: '1-1', label: '1-1', defaultOdds: 6.50 }, { key: '0-0', label: '0-0', defaultOdds: 8.00 }, { key: '0-1', label: '0-1', defaultOdds: 9.00 }, { key: '0-2', label: '0-2', defaultOdds: 12.00 }, { key: '1-2', label: '1-2', defaultOdds: 12.00 }, { key: '2-2', label: '2-2', defaultOdds: 15.00 }, { key: 'OTHER', label: 'Any Other', defaultOdds: 15.00 }], sort: 15, active: true, icon: 'grid' },
