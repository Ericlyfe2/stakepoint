/** BetXentra fixture book — static fallback + live merge from The Odds API */
...
/** Correct Score grid (25 scores + Other), derived from 1X2 + O/U 2.5 odds. */
export function buildCorrectScoreMarket({ home, draw, away, over = 1.95, under = 1.85 }) {
  const rH = 1 / home, rD = 1 / draw, rA = 1 / away;
  const sumM = rH + rD + rA;
  const pH = rH / sumM, pA = rA / sumM;
...
export function buildMarkets({ odds, ou = [1.85, 1.95], btts = [1.72, 2.05], dc }) {
  ...
  return {
    ...
    'CS': buildCorrectScoreMarket({ home, draw, away, over, under }),
...
export const CASINO_GAMES = [
  { id: 'dice',      title: 'Dice',      provider: 'BetXentra Originals', category: 'Instant', rtp: 99.0, hot: true,  hue: '#22c55e', route: '/casino/dice',      tagline: 'Pick a target. Roll the dice.' },
  { id: 'spin2win',  title: 'Spin2Win',  provider: 'BetXentra Originals', category: 'Instant', rtp: 97.3, hot: true,  hue: '#c81e1e', route: '/casino/spin2win',  tagline: 'Roulette-style number grid.'   },
  { id: 'red-black', title: 'Red Black', provider: 'BetXentra Originals', category: 'Instant', rtp: 98.0,             hue: '#0ea5e9', route: '/casino/red-black', tagline: 'Flip the card. Pays 2x.'       },
];
